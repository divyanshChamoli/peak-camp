...
export default function ButtonCreateAccount({placeholder, onClick}: ButtonCreateAccount){
    return(
        <button className=" bg-secondary w-full text-sm my-2 p-3 rounded-md" onClick={onClick}>
            {placeholder}
